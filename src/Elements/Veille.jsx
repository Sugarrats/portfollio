// cette page va présenter ma veille informatique, avec des liens vers des documents PDF.

import React, { useRef, useEffect, useState } from "react";
import Draggable from "react-draggable";
import { FileUser } from "lucide-react";

export default function Modal({ isOpen, onClose, title = "veille", children }) {
      ...
      >
        ...
        >
          ...
          <div className="px-4 py-2 space-y-2 text-primaire text-base text-left">
            <p>
              pendant ma formation j'ai aussi réalisé une veille informatique sur le langage de programmation
               <span className="text-secondaire font-bold"> ZIG.</span>
            </p>
          </div>
