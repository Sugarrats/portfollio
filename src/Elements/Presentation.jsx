            ...
            <div className="container mx-auto text-center z-10 px-0">
                <div className="w-full px-0">
                    <div className="bg-fenetre border-2 border-bordure rounded-lg mx-auto pt-0 pb-0 overflow-hidden w-1/2" >
                        ...
                        <div className="p-2">
                            <h1>
                                <span className="text-primaire text-2xl font-bold">bonjour! </span>
                                <span className="text-secondaire text-2xl font-bold"> je suis adrien</span>
                            </h1>
                        </div>

                        <div className="p-2 flex justify-center">
                            <h1 className="text-center flex items-center gap-1.5 text-base font-bold">
